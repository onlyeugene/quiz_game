...
const HomeSection = () => {
  ...
  return (
    <section className="block__home__section">
      <h3 ref={homeRef} tabIndex="0">
        Choose one from the categories below and see how many questions you can
      ...
      <button
        className="block__home__section__submit"
