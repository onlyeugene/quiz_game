  ...
  return (
    <>
      ...
      <div className="block__section__changePage">
        <button
          className="block__section__prev"
        ...
        <button
          ref={nextButtonRef}
          className="block__section__next"
          aria-label={currentPage === 10 ? "Check Result" : "Next Question"}
          onClick={
            selected ? (currentPage === 10 ? checkAnswer : nextQuestion) : null
          }
        >
